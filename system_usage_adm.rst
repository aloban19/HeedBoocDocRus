...
В случае выбора параметра «Фраза сотрудника» система не будет проводить анализ употребления данной фразы клиентами компании. Данная функция активируется при работе с двумя микрофонами, см. :ref:`session-label`_. 
...
.. important:: Убедитесь, что для веб-страницы http://heedbook.com разрешена отправка уведомлений (функции управления параметрами доступа находятся в настройках Вашего браузера).
