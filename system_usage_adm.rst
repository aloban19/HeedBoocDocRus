...
В случае выбора параметра «Фраза сотрудника» система не будет проводить анализ употребления данной фразы клиентами компании. Данная функция активируется при работе с двумя микрофонами, см. раздел Использование системы (Сотрудник) . 
